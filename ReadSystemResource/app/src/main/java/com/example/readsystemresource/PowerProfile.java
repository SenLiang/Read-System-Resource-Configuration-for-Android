...
public class PowerProfile {
    ...
    private Context mContext; // MOT, a18273, IKSWM-23739

    private static final String TAG = "ReadSystemResource";
    ...
    public PowerProfile(Context context, boolean forTest) {
        mContext =  context; // MOT, a18273, IKSWM-23739
    ...
    private void readPowerValuesFromXml(Context context, boolean forTest) {
        //final int id = com.android.internal.R.xml.power_profile;

        int resourceId = Resources.getSystem().getIdentifier("power_profile", "xml", "android");

        Log.e(TAG, "readPowerValuesFromXml resourceId=" + resourceId);
        ...
        int[] configResIds = new int[]{
                Resources.getSystem().getIdentifier("config_bluetooth_idle_cur_ma", "integer", "android"),
                Resources.getSystem().getIdentifier("config_bluetooth_rx_cur_ma", "integer", "android"),
                Resources.getSystem().getIdentifier("config_bluetooth_tx_cur_ma", "integer", "android"),
                Resources.getSystem().getIdentifier("config_bluetooth_operating_voltage_mv", "integer", "android"),
...
//                com.android.internal.R.integer.config_bluetooth_operating_voltage_mv,
        ...
        Log.e(TAG, "readPowerValuesFromXml configResIds=" + Arrays.toString(configResIds));
    ...
    public double getBatteryCapacity() {
        ...
        if (bm != null) {
            long capacity = bm.getLongProperty(BATTERY_PROPERTY_CHARGE_FULL);
            if (capacity != Long.MIN_VALUE) {
